...
(
    ...
    film_release_date DATE CHECK (film_release_date >= DATE '1895-12-28'),
    film_duration INTEGER,
    film_mpa_rating_id INTEGER,
    PRIMARY KEY (film_id),
    CONSTRAINT fk_films_mpa_rating FOREIGN KEY (film_mpa_rating_id) REFERENCES mpa_ratings(mpa_id)
);
